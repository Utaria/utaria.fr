...
<html>
	<head>
		...
		<link href="/css/timecircles.css?v=2.1" rel="stylesheet">
		<link href="/css/app.css?v=2.1" rel="stylesheet">
	</head>
	<body>
		<section class="content wrapper">
			<img class="logo" src="/img/logo.png?v=2.1" alt="Logo d'Utaria">
		...
		<script type="text/javascript" src="/js/backstretch.js?v=2.1"></script>
		<script type="text/javascript" src="/js/timecircles.js?v=2.1"></script>
